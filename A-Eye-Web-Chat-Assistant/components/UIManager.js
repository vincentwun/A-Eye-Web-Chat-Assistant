export class UIManager {
  constructor(elements) {
      ...
      if (!this.elements || !this.elements.conversation) {
          console.error("UIManager initialized with missing essential elements (e.g., conversation).");
      }
  }
  ...
  updateModeUI(activeMode, localApiUrl, ollamaMultimodalModel, cloudApiKey) {
      if (!this.elements.localModeOptions || !this.elements.cloudModeOptions ||
          !this.elements.localModeButton || !this.elements.cloudModeButton ||
          !this.elements.localUrlInput || !this.elements.localModelNameInput ||
          !this.elements.cloudApiKeyInput) {
          console.warn("Cannot update mode UI, essential elements missing.");
          return;
      }
      ...
      this.elements.localUrlInput.value = localApiUrl || '';
      this.elements.localModelNameInput.value = ollamaMultimodalModel || '';
      this.elements.cloudApiKeyInput.value = cloudApiKey || '';
  }
